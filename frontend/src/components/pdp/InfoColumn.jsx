  ...
  return (
    <div className="pt-2 flex flex-col gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <button type="button" aria-label="Add to cart" disabled={addDisabled} onClick={onAddToCart}
          className={`flex-1 py-3 rounded-full font-medium text-sm ${addDisabled
            ? "bg-gray-300 text-gray-600" : "bg-black text-white"
            }`}>
          Add to cart
        </button>
        <button
